    ...
    <>
        ...
        <div className='md:flex gap-4 md:mx-28 px-8'>
            ...
            <div className="relative">
                <img className=" h-[300px] w-auto rounded-[25px] p-2  " src="https://github.com/arpan-kumar-saini/examsafari/blob/main/public/images/allahabad1.jpeg" alt="dummy-image"/>
            ...
            <Link to="/lucknow">
            <div className="relative">
                <img className=" h-[300px] w-auto rounded-[25px] p-2" src="https://github.com/arpan-kumar-saini/examsafari/blob/main/public/images/lucknow1.jpeg" alt="dummy-image"/>
            ...
            <Link to="/kanpur">
            <div className="relative">
                <img className="h-[300px] w-auto rounded-[25px] p-2" src="https://github.com/arpan-kumar-saini/examsafari/blob/main/public/images/kanpur.jpeg" alt="dummy-image"/>
                <a href="" className='absolute top-1 ml-2 text-2xl font-semibold text-neutral-50 pt-6 pl-4'></a>
