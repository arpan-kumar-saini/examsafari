...
function AcoFeature() {
  return (
    <>
      <div>
          <div className='text- md:text-3xl font-bold text-[#374151] ml-20 md:ml-32 pt-6 md:pt-20 '>Book your Perfect Accommodation</div>
          <div className='text-sm md:text-2xl text-[#6B7280]  px-6 text-center md:text-left md:px-0 md:ml-32 md:mt-2'>Take the hassle out of securing your student home for the best years of your life </div>
